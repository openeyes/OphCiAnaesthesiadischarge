...
class OphCiAnaesthesiadischargeModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphCiAnaesthesiadischarge.models.*',
			'OphCiAnaesthesiadischarge.components.*',
		));

		$this->moduleShortSuffix = "anaesthesiadischarge";
	}
